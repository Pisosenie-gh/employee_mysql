...
Revision ID: bbfe8e21e7ac
Revises: 3c08917f8aba
Create Date: 2022-05-16 10:46:00.431664
...
revision = 'bbfe8e21e7ac'
down_revision = '3c08917f8aba'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('nameRu', sa.VARCHAR(length=255), nullable=True),
    sa.Column('nameKz', sa.VARCHAR(length=255), nullable=True),
    ...
    sa.Column('iin', sa.VARCHAR(length=255), nullable=True),
    sa.Column('personnelNumber', sa.VARCHAR(length=255), nullable=True),
    ...
    sa.Column('isActive', sa.VARCHAR(length=255), nullable=True),
