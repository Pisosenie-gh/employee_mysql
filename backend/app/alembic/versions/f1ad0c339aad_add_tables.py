...
Revision ID: f1ad0c339aad
Revises: ca7a220897e9
Create Date: 2022-05-16 09:24:18.377256
...
revision = 'f1ad0c339aad'
down_revision = 'ca7a220897e9'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('nameRu', sa.String(length=255), nullable=True),
    ...
    sa.Column('personnelNumber', sa.String(length=255), nullable=True),
